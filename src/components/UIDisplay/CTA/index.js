...
* Phone 0972970075
*
* Created: 2023-07-17 20:36:49

* Last updated on: 2023-07-17 20:36:49
			...
			<div className="custom-screen">
				<div className="max-w-3xl space-y-6 text-gray-600 dark:text-gray-300">
					...
					<p>
						...
						<Link href="#pricing" className="text-blue-600 hover:text-blue-400 dark:text-sky-500 dark:hover:text-sky-600 inline-flex items-center gap-x-1 duration-150">
							Try this course
